...
\begin{tikzpicture}[align=center, node distance=6em]
	\node[state,initial]    (s001)               {$001$};
	\node[state]            (s101)[right=of s001]{$101$};
	\node[state, accepting] (s102)[right=of s101]{$102$};
	\node[state, accepting] (s103)[below=2ex of s102]{$103$};
	\node[state, accepting] (s104)[below=2ex of s103]{$104$};
	\node[state, accepting] (s105)[below=2ex of s104]{$105$};
	\node[state, accepting] (s106)[below=2ex of s105]{$106$};
	\node[state, accepting] (s107)[below=2ex of s106]{$107$};
	\path[->](s001) edge node[above] {$\backslash$} (s101)
	                edge[bend right] node[right] {other} (s107)
	         (s101) edge node[above] {t} (s102)
	                edge[bend right] node[above] {n} (s103)
	                edge[bend right] node[above] {r} (s104)
	                edge[bend right] node[above] {"} (s105)
	                edge[bend right] node[above] {$\backslash$} (s106);
\end{tikzpicture}